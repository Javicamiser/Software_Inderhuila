  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
      <div style={{ border:`1px solid ${T.border}`, borderRadius:T.radius, overflow:'hidden' }}>
        ...
        <div style={{ padding:'14px 16px' }}>
          <select value={data.tipoCita || ''} onChange={e => updateData({ tipoCita: e.target.value })}
            required
      ...
      <Campo
        ...
        <textarea value={data.motivoConsulta} rows={4}
      ...
      <Campo
        ...
        <textarea value={data.enfermedadActual} rows={6}
