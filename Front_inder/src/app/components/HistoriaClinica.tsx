      ...
      actions: [
        {
          ...
          onClick: async () => {
            ...
            try {
              ...
              // Mostrar diálogo post-guardado: Agendar cita o Nueva historia
              showAlert('success', '¡Historia Clínica Guardada!', 'La historia clínica ha sido guardada correctamente. ¿Qué desea hacer a continuación?', {
                actions: [
                  {
                    label: '📅 Agendar Cita',
                    onClick: () => {
